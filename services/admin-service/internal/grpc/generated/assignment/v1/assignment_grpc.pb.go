...
const (
	AssignmentService_GetExperimentsAndVariantsForBucket_FullMethodName = "/assignment.v1.AssignmentService/GetExperimentsAndVariantsForBucket"
)
...
func (c *assignmentServiceClient) GetExperimentsAndVariantsForBucket(ctx context.Context, in *GetExperimentsAndVariantsForBucketRequest, opts ...grpc.CallOption) (*GetExperimentsAndVariantsForBucketResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetExperimentsAndVariantsForBucketResponse)
	err := c.cc.Invoke(ctx, AssignmentService_GetExperimentsAndVariantsForBucket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAssignmentServiceServer) GetExperimentsAndVariantsForBucket(context.Context, *GetExperimentsAndVariantsForBucketRequest) (*GetExperimentsAndVariantsForBucketResponse, error) {
...
func _AssignmentService_GetExperimentsAndVariantsForBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetExperimentsAndVariantsForBucketRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssignmentServiceServer).GetExperimentsAndVariantsForBucket(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AssignmentService_GetExperimentsAndVariantsForBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssignmentServiceServer).GetExperimentsAndVariantsForBucket(ctx, req.(*GetExperimentsAndVariantsForBucketRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AssignmentService_GetExperimentsAndVariantsForBucket_Handler,
		},
	},
