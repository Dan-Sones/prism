...
const EventsCatalogSearch = ({ onSearch }: EventsCatalogSearchProps) => {
  return (
    <div className="flex h-12 w-full flex-row items-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 shadow-sm focus-within:border-gray-400 lg:max-w-96">
